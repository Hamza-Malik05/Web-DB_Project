...
-- TRANSACTIONS
CREATE TYPE transaction_type AS ENUM ('withdrawal', 'deposit','salary');
CREATE TYPE payment_method_type AS ENUM ('cash', 'bank_transfer', 'credit_card','cheque', 'mobile_payment');
